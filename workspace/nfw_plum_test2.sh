...
python ../dsphsim/simulator.py --stellar_mass 2000 --rhalf 0.03 --rs 0.03 --rhos 17683882.565766152 --distance 23 --kinematics Physical temp.txt
python ../dsphsim/vdisp.py temp.txt
echo "Mock 0 (Segue 1) rp/rn=0.010"
python ../dsphsim/simulator.py --stellar_mass 2000 --rhalf 0.03 --rs 3.000 --rhos 12283.87504583 --distance 23 --kinematics Physical temp.txt
python little_A_test.py temp.txt 0.010 1439.601
echo "Mock 0 (Segue 1) rp/rn=0.032"
python ../dsphsim/simulator.py --stellar_mass 2000 --rhalf 0.03 --rs 0.949 --rhos 51073.92378452 --distance 23 --kinematics Physical temp.txt
python little_A_test.py temp.txt 0.032 346.241
echo "Mock 0 (Segue 1) rp/rn=0.100"
python ../dsphsim/simulator.py --stellar_mass 2000 --rhalf 0.03 --rs 0.300 --rhos 234474.36477690 --distance 23 --kinematics Physical temp.txt
python little_A_test.py temp.txt 0.100 75.419
echo "Mock 0 (Segue 1) rp/rn=0.316"
python ../dsphsim/simulator.py --stellar_mass 2000 --rhalf 0.03 --rs 0.095 --rhos 1287837.09952412 --distance 23 --kinematics Physical temp.txt
python little_A_test.py temp.txt 0.316 13.731
echo "Mock 0 (Segue 1) rp/rn=1.000"
python ../dsphsim/simulator.py --stellar_mass 2000 --rhalf 0.03 --rs 0.030 --rhos 9604975.33097231 --distance 23 --kinematics Physical temp.txt
python little_A_test.py temp.txt 1.000 1.841
echo "Mock 0 (Segue 1) rp/rn=3.162"
python ../dsphsim/simulator.py --stellar_mass 2000 --rhalf 0.03 --rs 0.009 --rhos 106578489.10215269 --distance 23 --kinematics Physical temp.txt
python little_A_test.py temp.txt 3.162 0.166
echo "Mock 0 (Segue 1) rp/rn=10.000"
python ../dsphsim/simulator.py --stellar_mass 2000 --rhalf 0.03 --rs 0.003 --rhos 1677238706.96551347 --distance 23 --kinematics Physical temp.txt
python little_A_test.py temp.txt 10.000 0.011
echo "Mock 0 (Segue 1) rp/rn=31.623"
python ../dsphsim/simulator.py --stellar_mass 2000 --rhalf 0.03 --rs 0.001 --rhos 33174816475.17483902 --distance 23 --kinematics Physical temp.txt
